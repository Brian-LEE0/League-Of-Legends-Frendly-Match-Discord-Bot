...
def get_league_info_from_league(league_id):
    return cache.get_json_from_redis(f"league_info:{league_id}")

def set_league_to_league_info(league_id, league_info):
    return cache.save_json_to_redis(f"league_info:{league_id}",league_info)